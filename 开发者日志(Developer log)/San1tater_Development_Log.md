...
---
### [Sep 27, 2025] Help功能 (Help function completed)  
...
---
### [Sep 28, 2025] 商品类 (Product category Class)  
* 功能描述: 创建好商品类别, 可以直接引用创建
* 涉及文件: model/Product.java
* 完成状态: 已完成|已测试
* 备注: 无。 

### [Sep 28, 2025] 添加商品信息功能 (Add product information)  
* 功能描述: 添加商品信息功能入口与功能
* 涉及文件: service/ProductList.java
* 完成状态: 已完成|已测试
* 备注: 无。 

### [Sep 28, 2025] 添加商品存货功能 (Add product inventory)  
* 功能描述: 添加商品存货功能入口与功能
* 涉及文件: service/ProductList.java
* 完成状态: 已完成|未测试
* 备注: 无。

### [Sep 28, 2025] 减少商品存货功能 (Reduce product inventory) 
* 功能描述: 减少商品存货功能入口与功能
* 涉及文件: service/ProductList.java
* 完成状态: 已完成|未测试
* 备注: 无。

### [Sep 28, 2025] 整数输入测试功能 (Integer input test)  
* 功能描述: 整数输入测试功能入口与功能
